...
namespace Neo.SmartContract
{
    public class PhantasmaContract : Framework.SmartContract
    {
        ...
        public static string Symbol() => "SOUL14";
        ...
        public const ulong initialSupply = team_supply + advisor_supply + presale_supply + platform_supply + sale1_supply;
        ...
        public const ulong token_war_cap = 2000 * token_swap_rate; // max tokens than an individual can buy from to the sale in the second round, not guaranteed

        public const uint ico_start_time = 1527268586;
        public const uint ico_war_time = ico_start_time + (4 * 3600);  // 3h margin to test round1
        public const uint ico_end_time = ico_war_time + (1*3600);  // 1h margin to test round1
